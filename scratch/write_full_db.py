...
export const UNIVERSITY_ADMISSIONS_DB: UniversityData[] = [
  // ==========================================
  // 1. 인하대학교 (INHA UNIVERSITY) - 27개 학과
  // ==========================================
  {
    univId: 'inha',
    univName: '인하대학교',
  ...
  // ==========================================
  // 2. 국립인천대학교 (INCHEON NATIONAL UNIVERSITY) - 24개 학과
  // ==========================================
  {
    univId: 'incheon',
    univName: '국립인천대학교',
  ...
  // ==========================================
  {
    ...
    departments: [
      // 1) 인문대학 (서울)
      {
        ...
        susiJonghap: { expectedCut5: 1.52, minCsatDesc: '수능최저 없음 (서류 100% + 면접)', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'ga', percentileCut: 89.0, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '영어영문학과',
        collegeName: '인문대학 (서울)',
        ...
        susiJonghap: { expectedCut5: 1.60, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'ga', percentileCut: 89.2, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '유럽문화학부 (독일어문/프랑스어문/러시아어문)',
        collegeName: '인문대학 (서울)',
        ...
        jeongsi: { group: 'na', percentileCut: 88.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        ...
        jeongsi: { group: 'ga', percentileCut: 88.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '철학과',
        collegeName: '인문대학 (서울)',
        ...
        jeongsi: { group: 'ga', percentileCut: 88.2, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '역사학과',
        collegeName: '인문대학 (서울)',
      ...
      {
        deptName: '정치국제학과',
        collegeName: '사회과학대학 (서울)',
        susiGyogwa: { expectedCut5: 1.20, minCsatDesc: '국수영탐(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        ...
        jeongsi: { group: 'ga', percentileCut: 89.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '심리학과',
        collegeName: '사회과학대학 (서울)',
        ...
        jeongsi: { group: 'na', percentileCut: 90.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '문헌정보학과',
        collegeName: '사회과학대학 (서울)',
      ...
      },
      {
        ...
        jeongsi: { group: 'na', percentileCut: 88.8, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '사회학과',
        collegeName: '사회과학대학 (서울)',
        susiGyogwa: { expectedCut5: 1.23, minCsatDesc: '국수영탐(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.60, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 89.0, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '도시계획·부동산학과',
        collegeName: '사회과학대학 (서울)',
      ...
      },
      {
        ...
        jeongsi: { group: 'ga', percentileCut: 90.8, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        ...
        jeongsi: { group: 'ga', percentileCut: 90.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      ...
      // 3) 사범대학 (서울)
      {
        ...
        collegeName: '사범대학 (서울)',
        susiGyogwa: { expectedCut5: 1.22, minCsatDesc: '국수영탐(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.41, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 89.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '유아교육과',
        collegeName: '사범대학 (서울)',
      ...
      },
      {
        ...
        susiGyogwa: { expectedCut5: 1.20, minCsatDesc: '국수영탐(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.39, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'reach', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'ga', percentileCut: 89.8, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '체육교육과',
        collegeName: '사범대학 (서울)',
        susiGyogwa: { expectedCut5: 1.37, minCsatDesc: '국수영탐(1) 3개 합 8 이내', requiredSubjectsCount: 3, sumGradeLimit: 8, susiCategory: 'reach', admissionType: '교과' },
        ...
        jeongsi: { group: 'na', percentileCut: 85.0, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },

      // 4) 경영경제대학 (서울)
      {
        deptName: '경영학부 (경영학)',
        collegeName: '경영경제대학 (서울)',
        ...
        susiJonghap: { expectedCut5: 1.50, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        ...
        susiJonghap: { expectedCut5: 1.48, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        ...
        collegeName: '경영경제대학 (서울)',
        susiGyogwa: { expectedCut5: 1.18, minCsatDesc: '국수영탐(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.46, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        deptName: '산업보안학과 (자연)',
        collegeName: '경영경제대학 (서울)',
        susiGyogwa: { expectedCut5: 1.17, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
      ...
      {
        deptName: '수학과',
        collegeName: '자연과학대학 (서울)',
        susiGyogwa: { expectedCut5: 1.20, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
      ...
      },
      {
        deptName: '물리학과',
        collegeName: '자연과학대학 (서울)',
        susiGyogwa: { expectedCut5: 1.23, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
      ...
      },
      {
        deptName: '화학과',
        collegeName: '자연과학대학 (서울)',
        susiGyogwa: { expectedCut5: 1.18, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.48, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU탐구형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 90.2, subjectWeights: { korean: 25, math: 40, inquiry: 35, english: 0, history: 0 } },
      },
      {
        deptName: '생명과학과',
        collegeName: '자연과학대학 (서울)',
        susiGyogwa: { expectedCut5: 1.15, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
      ...
      // 6) 공과대학 (서울/다빈치)
      {
        deptName: '화학공학과',
        collegeName: '공과대학 (서울)',
        susiGyogwa: { expectedCut5: 1.16, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.39, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'reach', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        ...
        collegeName: '공과대학 (서울)',
        susiGyogwa: { expectedCut5: 1.24, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.60, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        ...
        collegeName: '공과대학 (서울)',
        susiGyogwa: { expectedCut5: 1.26, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.67, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        ...
        susiGyogwa: { expectedCut5: 1.62, minCsatDesc: '국수영과(1) 2개 합 6 이내', requiredSubjectsCount: 2, sumGradeLimit: 6, susiCategory: 'target', admissionType: '교과' },
      ...
      {
        deptName: '전자전기공학부',
        collegeName: '창의ICT공과대학 (서울)',
        susiGyogwa: { expectedCut5: 1.13, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.37, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'reach', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        deptName: '지능형반도체공학과',
        collegeName: '창의ICT공과대학 (서울)',
        susiGyogwa: { expectedCut5: 1.14, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.35, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'reach', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      // 9) 의학 / 약학 / 간호대학 (서울)
      {
        deptName: '의학부 (의예과)',
        collegeName: '의과대학 (서울)',
        susiGyogwa: { expectedCut5: 1.00, minCsatDesc: '국수영과(2) 4개 합 5 이내', requiredSubjectsCount: 4, sumGradeLimit: 5, susiCategory: 'reach', admissionType: '교과' },
      ...
      {
        deptName: '간호학과 (자연)',
        collegeName: '적십자간호대학 (서울)',
        susiGyogwa: { expectedCut5: 1.19, minCsatDesc: '국수영과(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.46, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
      ...
      },
      {
        ...
        collegeName: '적십자간호대학 (서울)',
        susiGyogwa: { expectedCut5: 1.18, minCsatDesc: '국수영탐(1) 3개 합 7 이내', requiredSubjectsCount: 3, sumGradeLimit: 7, susiCategory: 'reach', admissionType: '교과' },
        susiJonghap: { expectedCut5: 1.44, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 89.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      ...
      // 10) 생명공학대학 (다빈치)
      {
        ...
        susiGyogwa: { expectedCut5: 1.72, minCsatDesc: '국수영과(1) 2개 합 6 이내', requiredSubjectsCount: 2, sumGradeLimit: 6, susiCategory: 'safe', admissionType: '교과' },
      ...
      },
      {
        ...
        collegeName: '생명공학대학 (다빈치)',
        susiGyogwa: { expectedCut5: 1.79, minCsatDesc: '국수영과(1) 2개 합 6 이내', requiredSubjectsCount: 2, sumGradeLimit: 6, susiCategory: 'safe', admissionType: '교과' },
      ...
      },
      {
        deptName: '식품공학부 (식품공학)',
        collegeName: '생명공학대학 (다빈치)',
        susiGyogwa: { expectedCut5: 1.87, minCsatDesc: '국수영과(1) 2개 합 6 이내', requiredSubjectsCount: 2, sumGradeLimit: 6, susiCategory: 'safe', admissionType: '교과' },
      ...
      },
      {
        ...
        collegeName: '생명공학대학 (다빈치)',
        susiGyogwa: { expectedCut5: 1.87, minCsatDesc: '국수영과(1) 2개 합 6 이내', requiredSubjectsCount: 2, sumGradeLimit: 6, susiCategory: 'safe', admissionType: '교과' },
        susiJonghap: { expectedCut5: 2.00, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'safe', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 82.0, subjectWeights: { korean: 25, math: 40, inquiry: 35, english: 0, history: 0 } },
      },
      {
        deptName: '시스템생명공학과',
        collegeName: '생명공학대학 (다빈치)',
        susiGyogwa: { expectedCut5: 1.28, minCsatDesc: '국수영과(1) 2개 합 6 이내', requiredSubjectsCount: 2, sumGradeLimit: 6, susiCategory: 'reach', admissionType: '교과' },
      ...
      },
      {
        ...
        collegeName: '예술대학 (서울)',
        susiJonghap: { expectedCut5: 1.67, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'target', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'ga', percentileCut: 85.0, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        ...
        jeongsi: { group: 'na', percentileCut: 84.0, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        ...
        susiJonghap: { expectedCut5: 1.90, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'safe', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 83.5, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
      {
        deptName: '사진학과',
        collegeName: '예술대학 (다빈치)',
        susiJonghap: { expectedCut5: 1.93, minCsatDesc: '수능최저 없음', requiredSubjectsCount: 0, sumGradeLimit: 0, susiCategory: 'safe', typeName: 'CAU융합형', admissionType: '종합' },
        jeongsi: { group: 'na', percentileCut: 82.0, subjectWeights: { korean: 35, math: 30, inquiry: 25, english: 10, history: 0 } },
      },
    ],
  },
